<p align="center">
  <a href="https://github.com/magichand-star"><img src="https://readme-typing-svg.herokuapp.com/?lines=AI%20Expert!;Senior%20Blockchain%20developer;Web%20and%20Mobile%20Expert;5%2B%20years%20of%20rich%20experience;Always%20learning%20new%20tech&font=Pacifico&center=true&width=650&height=120&color=58a6ff&vCenter=true&size=45%22"></a>
</p>
<p align="center">
...
ChatBotとAPI統合を構築するための2年以上の経験を持つAI専門家。 <br/>
高性能プレゼンテーション、レイヤー、再利用可能なコンポーネント、パフォーマンス最適化を構築する5年以上の経験を持つシニアフルスタック開発者。
React.js、Redux、Vue.js、NextJs - JavaScript、HTML、CSSを使用したフロントエンド開発。
